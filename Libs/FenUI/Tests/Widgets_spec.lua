...
describe("FenUI Widgets", function()
	...
	describe("Stack", function()
		it("should handle horizontal stack and wrap", function()
			...
			local c1 = CreateFrame("Frame", nil, stack)
			c1:SetSize(40, 20)
			local c2 = CreateFrame("Frame", nil, stack)
			c2:SetSize(40, 20)
			local c3 = CreateFrame("Frame", nil, stack)
			c3:SetSize(40, 20)
	...
	describe("Group", function()
		...
		it("should support the builder API", function()
			local group = FenUI.Group(UIParent):size(200, 100):padding(10):columns(2):build()
		...
		it("should handle margin and padding string resolutions", function()
			...
			FenUI.GetLayout = function(self, key)
				if key == "largePadding" then
					return 40
				end
				return 0
			end
	...
	describe("Image", function()
		...
		it("should handle various condition resolvers", function()
			...
			if img.texture:GetTexture() ~= "spec1_tex" then
				FenUI:RegisterImageCondition("spec", function()
					return 1
				end)
				img:Refresh()
			end
		...
		it("should register custom conditions", function()
			FenUI:RegisterImageCondition("custom", function()
				return "key"
			end)

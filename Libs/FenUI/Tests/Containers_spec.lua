...
describe("FenUI Container Widgets", function()
	...
	describe("Panel", function()
		...
		it("should support the builder pattern (fluent API)", function()
			local panel = FenUI.Panel(UIParent):title("Fluent Panel"):size(500, 400):movable(true):build()
	...
	describe("Tabs", function()
		...
		it("should support the builder API", function()
			local tabGroup = FenUI.TabGroup(UIParent):tab("a", "A"):tab("b", "B"):height(40):build()
